export const mockProps = [
  ...
  { id: "p3", name: "Jarrón cerámico miel", code: "HD-VA-007", category: "Decoración", style: "Orgánico", state: "En mantenimiento", price: 380, photo: "", art: "vase", colors: ["#ecd9c8", "#ad593b"] },
  ...
  { id: "p5", name: "Pedestal mármol crema", code: "HD-PE-011", category: "Pedestales", style: "Editorial", state: "Rentado", price: 760, photo: "", art: "pedestal", colors: ["#efe4d2", "#b7aa99"] },
  ...
  { id: "p7", name: "Biombo lino natural", code: "HD-BI-006", category: "Fondos", style: "Minimal", state: "En mantenimiento", price: 1200, photo: "", art: "screen", colors: ["#f0dfc4", "#93836f"] },
  ...
  { id: "p11", name: "Candelabro de bronce", code: "HD-CA-009", category: "Decoración", style: "Art déco", state: "Rentado", price: 320, photo: "", art: "lamp", colors: ["#ead6a6", "#8b6d2f"] },
...
export const mockRentals = [
  { id: "r1", propIds: ["p2", "p5"], start: "2026-06-06", end: "2026-06-08", status: "Activa" },
  { id: "r2", propIds: ["p8"], start: "2026-06-10", end: "2026-06-13", status: "Activa" },
  { id: "r3", propIds: ["p10"], start: "2026-06-14", end: "2026-06-15", status: "Activa" }
];
